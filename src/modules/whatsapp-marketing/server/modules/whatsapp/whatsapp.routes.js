...
import * as flowsController from "./flows.controller.js";
...
router.get("/flows/responses/summary", requireAuth, flowsController.getFlowResponseSummary);
router.get("/flows/responses", requireAuth, flowsController.getFlowResponses);
router.get("/flows/reports", requireAuth, flowsController.getFlowReports);
router.get("/flows/reports/:id/details", requireAuth, flowsController.getFlowReportDetails);
router.get("/flows/responses/:id", requireAuth, flowsController.getFlowResponseById);
...
router.post("/flows/endpoint/:token", flowsController.receiveFlowEndpoint);
router.post("/flows/:id/endpoint/setup", requireAuth, flowsController.setupFlowEndpoint);
...
router.post("/flows/:id/send-conversation", requireAuth, flowsController.sendConversationTest);
