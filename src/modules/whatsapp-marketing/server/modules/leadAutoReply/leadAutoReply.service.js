import * as mappingService from "../mapping/mapping.service.js";
import * as agentService from "../aiAgents/agent.service.js";
import * as mongodb from "../storage/mongodb.adapter.js";
import * as templateService from "./templateMessages.service.js";
...
async function processAllPendingLeads() {
  const leads = await mongodb.readCollection("leads");
...
async function sendManualReply(leadId, message) {
  const lead = await mongodb.findOne("leads", { id: leadId });
  if (!lead) {
