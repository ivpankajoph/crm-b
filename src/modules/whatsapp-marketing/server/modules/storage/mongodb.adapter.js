...
const Leadfb = mongoose.models.Leadfb || mongoose.model("Leadfb", leadSchema_fb);
const FormAutomation = mongoose.models.FormAutomation || mongoose.model("FormAutomation", formAutomationSchema);
const DripStep = mongoose.models.DripStep || mongoose.model("DripStep", stepSchema);
const LeadDripStatus = mongoose.models.LeadDripStatus || mongoose.model("LeadDripStatus", leadDripStatusSchema);
...
const Trigger = mongoose.models.Trigger || mongoose.model("Trigger_m", TriggerSchema);
...
const BroadcastList = mongoose.models.BroadcastList || mongoose.model("BroadcastList", BroadcastListSchema);
...
const ImportedContact = mongoose.models.ImportedContact || mongoose.model("ImportedContact", ImportedContactSchema);
const ContactAgent = mongoose.models.ContactAgent || mongoose.model("ContactAgent", ContactAgentSchema);
const Contact = mongoose.models.Contact || mongoose.model("Contact", ContactSchema);
const InterestClassificationLog = mongoose.models.InterestClassificationLog || mongoose.model("InterestClassificationLog", InterestClassificationLogSchema);
const Message = mongoose.models.Message || mongoose.model("Message", MessageSchema);
const Chat = mongoose.models.WhatsAppMarketingChatV2 || mongoose.model("WhatsAppMarketingChatV2", ChatSchema);
const Campaign = mongoose.models.Campaign || mongoose.model("Campaign", CampaignSchema);
const Template = mongoose.models.Template || mongoose.model("Template", TemplateSchema);
const Automation = mongoose.models.Automation || mongoose.model("Automation", AutomationSchema);
const User = mongoose.models.WhatsappUser || mongoose.model("WhatsappUser", UserSchema);
...
const PrefilledTextMapping = mongoose.models.PrefilledTextMapping || mongoose.model("PrefilledTextMapping", PrefilledTextMappingSchema);
const ScheduledBroadcast = mongoose.models.ScheduledBroadcast || mongoose.model("ScheduledBroadcast", ScheduledBroadcastSchema);
const BlockedContact = mongoose.models.BlockedContact || mongoose.model("BlockedContact", BlockedContactSchema);
const UserCredentials = mongoose.models.UserCredentials || mongoose.model("UserCredentials", UserCredentialsSchema);
const WebhookStatusEvent = mongoose.models.WebhookStatusEvent || mongoose.model("WebhookStatusEvent", WebhookStatusEventSchema);
const ContactAnalytics = mongoose.models.ContactAnalytics || mongoose.model("ContactAnalytics", ContactAnalyticsSchema);
const LeadAssignment = mongoose.models.LeadAssignment || mongoose.model("LeadAssignment", LeadAssignmentSchema);
const TeamHierarchy = mongoose.models.TeamHierarchy || mongoose.model("TeamHierarchy", TeamHierarchySchema);
const ActivityLog = mongoose.models.ActivityLog || mongoose.model("ActivityLog", ActivityLogSchema);
const UserActivityStats = mongoose.models.UserActivityStats || mongoose.model("UserActivityStats", UserActivityStatsSchema);
const modelMap = {
  agents: Agent,
  forms: Form,
  leads: Lead,
